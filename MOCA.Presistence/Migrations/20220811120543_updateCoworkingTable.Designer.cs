...
namespace MOCA.Presistence.Migrations
{
    ...
    [Migration("20220811120543_updateCoworkingTable")]
    partial class updateCoworkingTable
    {
            ...
            modelBuilder.Entity("MOCA.Core.Entities.LocationManagment.Coworking", b =>
                {
                    ...
                    b.Property<long>("CoworkingWorkspaceFurnishingFurnishingId")
                        .HasColumnType("bigint");

                    b.Property<long>("CoworkingWorkspaceFurnishingLocationId")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("CoworkingWorkspaceFurnishingLocationId", "CoworkingWorkspaceFurnishingFurnishingId");
            ...
            modelBuilder.Entity("MOCA.Core.Entities.LocationManagment.CoworkingWorkspaceFurnishing", b =>
                {
                    ...
                    b.HasKey("LocationId", "FurnishingId");
            ...
            modelBuilder.Entity("MOCA.Core.Entities.LocationManagment.Coworking", b =>
                {
                    ...
                    b.HasOne("MOCA.Core.Entities.LocationManagment.CoworkingWorkspaceFurnishing", "CoworkingWorkspaceFurnishing")
                        .WithMany()
                        .HasForeignKey("CoworkingWorkspaceFurnishingLocationId", "CoworkingWorkspaceFurnishingFurnishingId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
