...
namespace MOCA.Presistence.Repositories.WorkSpaceReservations
{
    public class WorkSpaceReservationsRepositoryCRM : IWorkSpaceReservationsRepositoryCRM
    {
        ...
        public async Task<IReadOnlyList<GetAllWorkSpaceSubmissionsResponse>> GetAllWorkSpaceSubmissions(GetAllWorkSpaceSubmissionsDto request)
        {
            ...
            var data = await _context.Connection.QueryAsync<GetAllWorkSpaceSubmissionsResponse>("dbo.SP_Work_n_Munch_Workspace_Submissions_GetAll_CRM", parms, null, (int) System.Data.CommandType.StoredProcedure);
            return data.AsList();
        }   
    }
}
